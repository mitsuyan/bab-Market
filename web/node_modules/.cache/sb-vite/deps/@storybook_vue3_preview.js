...
import {
  ...
  hasDocgen
} from "./chunk-DOIJA7HR.js";
import "./chunk-ABV5Z474.js";
import "./chunk-PQOM6AXN.js";
import "./chunk-ZCWJIERV.js";
import "./chunk-L7XZ4SWS.js";
import "./chunk-Z7F3OFGW.js";
import "./chunk-6M7Z437Q.js";
import "./chunk-R2MU4AY7.js";
import "./chunk-Q35J26HM.js";
import "./chunk-RBOW4WQ6.js";
import "./chunk-KSSUPYU5.js";
import "./chunk-FA42535T.js";
import "./chunk-Q4EKLYPK.js";
import "./chunk-ER3M4UVI.js";
import "./chunk-5PRNAEBM.js";
import "./chunk-ANBUHUHC.js";
import "./chunk-3YZOC57M.js";
import "./chunk-V6EYZELZ.js";
import "./chunk-Z5AVWR5O.js";
import "./chunk-PWDQWGRW.js";
import "./chunk-UEV7C6P4.js";
import "./chunk-FIVBKLHX.js";
import "./chunk-XVYBAQHJ.js";
import "./chunk-75JNXXUO.js";
import "./chunk-CSDURK6T.js";
import {
  require_preview_api
    ...
    (function() {
      ...
      var runInContext = function runInContext2(context) {
        ...
        function baseInvoke(object, path, args2) {
          ...
          return func == null ? undefined : apply(func, object, args2);
        }
        ...
        var defaultsDeep = baseRest(function(args2) {
          args2.push(undefined, customDefaultsMerge);
          return apply(mergeWith, undefined, args2);
        });
        ...
        function template(string, options, guard) {
          ...
          var result2 = attempt(function() {
            return Function2(importsKeys, sourceURL + "return " + source2).apply(undefined, importsValues);
          });
        ...
        var attempt = baseRest(function(func, args2) {
          try {
            return apply(func, undefined, args2);
          } catch (e) {
...
// node_modules/@storybook/vue3/dist/config.mjs
...
var extractArgTypes = (component) => {
  ...
  return SECTIONS.forEach((section) => {
    extractComponentProps(component, section).forEach(({ propDef, docgenInfo, jsDocTags }) => {
      let { name, type, description, defaultValue: defaultSummary, required } = propDef, sbType = section === "props" ? convert4(docgenInfo) : { name: "void" };
      results[name] = { name, description, type: { required, ...sbType }, table: { type, jsDocTags, defaultValue: defaultSummary, category: section } };
    });
  }), results;
};
...
function mapAttributesAndDirectives(props) {
  let tranformKey = (key) => key.startsWith("on") ? key : (0, import_lodash.kebabCase)(key);
...
function getComponents(template) {
  var _a;
  let components = (_a = baseParse(template)) == null ? void 0 : _a.children;
  return components || [];
}
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=@storybook_vue3_preview.js.map
